...
console.log('=== 奇门遁甲排盘 ===');
console.log('日期: 2026-06-25');
console.log('时间: 09:30');
...
console.log('');
console.log('【四柱八字】');
console.log('年柱:', data.sizhu ? data.sizhu.year.ganZhi : '未知');
console.log('月柱:', data.sizhu ? data.sizhu.month.ganZhi : '未知');
console.log('日柱:', data.sizhu ? (data.sizhu.day.ganZhi + ' (日干:' + data.sizhu.day.gan + ')') : '未知');
console.log('时柱:', data.sizhu ? (data.sizhu.hour.ganZhi + ' (时干:' + data.sizhu.hour.gan + ')') : '未知');
console.log('');
...
console.log('');
console.log('【交易用神位置】');
const dayGan = data.sizhu ? data.sizhu.day.gan : '';
const hourGan = data.sizhu ? data.sizhu.hour.gan : '';
...
fs.writeFileSync(outDir + '/qimen_data_20260625.json', JSON.stringify(data, null, 2));
console.log('');
console.log('数据已保存到 ' + outDir + '/qimen_data_20260625.json');
