...
document.getElementById('date').value = '2026-04-28';
...
gongOrder.forEach(gongNum => {
    ...
    if (tpGan === '辛') console.log(`辛金在 ${gongNames[gongNum]} - 神:${shen} 门:${men}`);
    if (tpGan === '己') console.log(`己土在 ${gongNames[gongNum]} - 神:${shen} 门:${men}`);
});
